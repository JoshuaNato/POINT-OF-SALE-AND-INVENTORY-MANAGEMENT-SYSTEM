...
<div class="container">
        ...
        <form class="row g-3">
            ...
            <div class="col-md-4 d-flex align-items-end">
                <button type="button" class="btn filter-btn w-100" id="filterBtn">Filter</button>
            </div>
        </form>
        <div class="mt-4">
            <p class="no-data" id="noDataMessage">No data to be display...</p>
        </div>
    </div>
    ...
    <div class="col-lg-4">
           <div class="card">
                <div class="card-header text-dark">
                    <b>Order List</b>
                <span class="float:right"><a class="btn btn-primary btn-sm col-sm-3 float-right" href="point-of-sale.php" id="">
...
<script>
   ...
   $('#tendered').keyup('input',function(e){
    ...
    <script>
        // JavaScript for handling filter button click
        document.getElementById('filterBtn').addEventListener('click', () => {
            const startDate = document.getElementById('startDate').value;
            const endDate = document.getElementById('endDate').value;

            // Simple logic to display message (modify as needed)
