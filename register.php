...
<body class="bg-gradient-primary">
    <div class="text-center p-4 p-lg-5">
        <h1 class="fw-bold mb-4"><span style="color: rgb(255, 159, 14);">IN TEA MATE MILKTEA STATION</span><span style="color: rgb(255, 255, 255);"> POINT OF SALE IVENTORY SYSTEM</span></h1>
    </div>
        ...
        <div class="card shadow-lg o-hidden border-0 my-5" style="border-radius: 20px;">
            <div class="card-body p-0">
                <div class="row">
                    ...
                    <div class="flex-grow-1 bg-register-image" id="registerImage" style="background: url('assets/img/milk.jpg'); background-size: 100%; background-position: center; background-repeat: no-repeat; width: 200%; height: 500px;"></div>
