...
<head>
    ...
    <title> Milktea In Tea Mate Point of Sale and Iventory System</title>
...
<body id="page-top">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <button class="btn btn-warning text-white" onclick="location.href='product.php';">+ Add new product</button>
    </div>
    <div class="input-group mb-3">
      <span class="input-group-text" id="basic-addon1"><i class="bi bi-search"></i></span>
      <input type="text" class="form-control" placeholder="Find Product" aria-label="Search" aria-describedby="basic-addon1">
    </div>
